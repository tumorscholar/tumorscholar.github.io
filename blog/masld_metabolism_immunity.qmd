...
image: blog_images/cover_masld.png
format:
  html:
    toc: true
...
But make no mistake, this is not a regional issue, it's a global public health problem. 
 ...
 <figure style="width: 75%; max-width: 720px; margin: 2em auto; display: block; text-align: center;">
  <img src="blog_images/masld.png" alt="MASLD — metabolism and immunity" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 18px rgba(0,0,0,0.12);">
